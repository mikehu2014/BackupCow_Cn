...
uses
  ...
  Spin, pngimage, UFrameFilter, UFileBaseInfo, siComp, UMainForm;
...
type
  ...
  TfrmSelectLocalBackupPath = class(TForm)
    ...
    siLang_frmSelectLocalBackupPath: TsiLang;
    ...
    procedure siLang_frmSelectLocalBackupPathChangeLanguage(Sender: TObject);
  private
...
uses
  ...
  ULocalBackupFace, UFormBackupPath, UFormBackupProperties;
...
begin
  ...
  siLang_frmSelectLocalBackupPathChangeLanguage( nil );
end;
...
procedure TfrmSelectLocalBackupPath.siLang_frmSelectLocalBackupPathChangeLanguage(
  Sender: TObject);
begin
  with vstSelectPath.Header do
  begin
    Columns[VstSelectLocalBackupPath_FileName].Text := frmSelectBackupPath.silang.GetText( 'vstFileName' );
    Columns[VstSelectLocalBackupPath_FileSize].Text := frmSelectBackupPath.silang.GetText( 'vstFileSize' );
    Columns[VstSelectLocalBackupPath_FileTime].Text := frmSelectBackupPath.silang.GetText( 'vstFileDate' );
  end;
  ...
  begin
    Columns[ 0 ].Caption := siLang_frmSelectLocalBackupPath.GetText( 'lvDestination' );
    Columns[ 1 ].Caption := siLang_frmSelectLocalBackupPath.GetText( 'lvFreeSpace' );
  end;

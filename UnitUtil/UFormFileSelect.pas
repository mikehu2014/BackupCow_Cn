...
uses
  ...
  Dialogs, VirtualTrees, UMyUtil, UIconUtil, ExtCtrls, StdCtrls, siComp, UMainForm;
...
type
  ...
  TfrmFileSelect = class(TForm)
    ...
    procedure siLang_frmFileSelectChangeLanguage(Sender: TObject);
  private
...
begin
  ...
  siLang_frmFileSelectChangeLanguage( nil );
end;
...
procedure TfrmFileSelect.siLang_frmFileSelectChangeLanguage(Sender: TObject);
begin
  with vstSelectPath.Header do
  begin
    Columns[ VstSelectFile_FileName ].Text := siLang_frmFileSelect.GetText( 'vstFileName' );
    Columns[ VstSelectFile_FileSize ].Text := siLang_frmFileSelect.GetText( 'vstFileSize' );
    Columns[ VstSelectFile_FileTime ].Text := siLang_frmFileSelect.GetText( 'vstFileDate' );
  end;
end;

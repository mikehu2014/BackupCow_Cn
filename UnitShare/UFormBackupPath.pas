...
uses
  FileCtrl, ShellAPI, Mask, ShlObj, ActiveX, UMyUtil, UBackupInfoControl, URegisterInfo, UMainForm;
    ...
    begin
      ...
      begin
        ...
        RemoveOldAddChildNode( ChildNode );
          ...
          // 控制器 //
        MyBackupFileControl.AddBackupPath( FullPath );
      end
      else
...
begin
  ...
  begin
    ...
    if FindFirst( FullPath + '*', faAnyfile - fahidden , sch ) = 0 then
    begin
      repeat
        FileName := sch.Name;
...
begin
  ...
  if FindFirst( FullPath + '*', faAnyfile - fahidden, sr ) = 0 then
  begin
    repeat
      FileName := sr.Name;

...
type
  ...
  private
    ...
    procedure OKClick;
  public
    procedure ReadRestorePcList; // 加载 Restore Pc 列表
...
begin
  ...
  if not ItemData.IsFileInvisible then // 没有加密
    Exit;
...
begin
  ...
  frmRestore.Caption := Format( frmRestore.siLang_frmRestore.GetText( 'StrRestoreTitle' ), [ItemData.PcName] );
    ...
    // 加载 Restore Pc 的 BackupPath List
...
begin
  ...
  if PathType = PathType_File then // 文件的情况
  begin
  ...
  if PathType = PathType_Folder then  // 目录的情况
  begin
